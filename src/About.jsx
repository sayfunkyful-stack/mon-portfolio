...
export default function About() {
  return (
    <section id="about" className="bg-linear-to-bl from-gray-900 from-10% to-black text-white py-24 px-6 text-center md:px-24 lg:px-48 content-center min-h-[100vh] ">
