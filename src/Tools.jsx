...
export default function Tools() {
  return (
    <section className="bg-gradient-to-r from-black from-10% to-gray-900 to-100% text-white py-24 px-6 text-center md:px-24 lg:px-48 min-h-[100vh]  content-center  ">
